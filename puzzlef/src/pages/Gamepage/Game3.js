...
const Game3 = () => {
  const [tiles, setTiles] = useState(Array(12).fill(null)); // null for unselected, 1 for player 1, 2 for player 2
      ...
      <div className='row'>
        <div className='upper-container my-3' style={containerStyle}>
          <GameContainer className='img'>
            <div className='des'>Level Four</div>
