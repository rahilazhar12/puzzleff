...
const Game7 = () => {
  const [tiles, setTiles] = useState(Array(20).fill(null)); // Adjusted array length to 25 for a 5x5 grid
      ...
      <div className='row'>
        <div className='upper-container my-3' style={containerStyle}>
          ...
          <div className='red'>Hard Level</div>
            <div className='des'>Level Eight</div>
            ...
            <h6 className='info'>Player 2 Selected: {selectedCountPlayer2} / {maxSelections}</h6>
              ...
              <div className='level'>
                <button className='button1'>
                  <Link to="/freezenova">Go to Home</Link>
                </button>
              </div>
